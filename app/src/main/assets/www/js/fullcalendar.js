	...
	fgSegHtml: function(seg) {
		...
		return '<tr class="' + classes.join(' ') + '">' +
			...
			'<td class="fc-list-item-title ' + view.widgetContentClass + '">' +
				...
				'</a><br>' +
                '<input type="button" value="Attend" class="btn btn-success calendar-btns" state_id="1">' +
                '<input type="button" value="Maybe" class="btn btn-info calendar-btns" state_id="2">' +
                '<input type="button" value="Decline" class="btn btn-danger calendar-btns" state_id="3">' +
			'</td>' +
		'</tr>';
	}
